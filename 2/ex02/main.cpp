...
/*   Updated: 2022/02/14 14:54:10 by jabenjam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void ) {
	{
		...
		std::cout << a << std::endl;
		std::cout << std::bitset<16>(a.getValue()) << std::endl;
		std::cout << ++a << std::endl;
		std::cout << std::bitset<16>(a.getValue()) << std::endl;
		std::cout << a << std::endl;
		std::cout << a++ << std::endl;
	...
	}	
	{
		...
		Fixed a(15);
		Fixed b(10);
		Fixed c(Fixed(5.05f) * Fixed(4));

		std::cout << "a value print : " << a << std::endl;
		std::cout << "b value print : " << b << std::endl;
		std::cout << "c value print : " << c << std::endl;

		std::cout << std::endl << "a division test" << std::endl;
		std::cout << a / b << std::endl;
		std::cout << "a value print : " << a << std::endl;
		std::cout << "b value print : " << b << std::endl;
		std::cout << "c value print : " << c << std::endl;
		std::cout << std::endl << "a mult test" << std::endl;
		std::cout << a * b << std::endl;
		std::cout << "a value print : " << a << std::endl;
		std::cout << "b value print : " << b << std::endl;
		std::cout << "c value print : " << c << std::endl;
		std::cout << std::endl << "a addition test" << std::endl;
		std::cout << a + b << std::endl;
		std::cout << "a value print : " << a << std::endl;
		std::cout << "b value print : " << b << std::endl;
		std::cout << "c value print : " << c << std::endl;
		std::cout << std::endl << "a substraction test" << std::endl;
