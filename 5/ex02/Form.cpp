...
/*   Updated: 2022/02/06 21:57:06 by jabenjam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Form::execute(Bureaucrat const & executor) const
{
	try
	{
		if (executor.getGrade() > this->getExecLvl())
			throw Form::GradeTooLowException();
	...
	{
		std::cout << this->getName() << " form can't be executed by " << executor.getName() << " because " << exception.what() << std::endl;
	}
}
